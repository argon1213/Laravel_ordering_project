...
Route::get('/alipay/api_return', 'PaymentApiController@alipayApiReturn')->name('alipay-api-return');
Route::post('/wechatpay/api_return', 'PaymentApiController@wechatpayApiReturn')->name('wechatpay-api-return');
